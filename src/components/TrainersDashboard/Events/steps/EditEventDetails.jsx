...
export default function EditEventDetails({ eventId, goBack, setActiveMenu }) {
  ...
  const inputStyle =
    "w-full max-w-full border border-orange-300 rounded-md p-2 text-sm md:text-base px-3 box-border focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500";
  return (
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-10">
          ...
          <div className="border border-orange-300 rounded-lg">
            ...
            <div className="p-3 space-y-3">
              {customers.map((c, i) => (
                <div key={i} className="flex justify-between items-start gap-2 flex-wrap sm:flex-nowrap">
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-full bg-gray-300"></div>

                    <span className="text-sm break-words pr-2 leading-5">
                      {c.name}
                    </span>
                  </div>
